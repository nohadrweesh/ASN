...
public class SpeedDataActivity extends AppCompatActivity {
    ...
    private final int loopFristNumber = 29;
    private final int loopLastNumber = 29;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_speed_data);
